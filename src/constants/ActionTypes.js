...
// Companies
export const GET_COMPANIES_START = 'GET_SERVICES_START';
export const GET_COMPANIES_SUCCESS = 'GET_SERVICES_SUCCESS';
export const GET_COMPANIES_FAILED = 'GET_SERVICES_FAILED';
